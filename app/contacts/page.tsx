            ...
            <div className="flex flex-col gap-4">
              {departments.map((dept, index) => (
                <div
                  ...
                  className="glass group hover:bg-cyprus hover:text-sand-dune p-6 rounded-2xl transition-all duration-300 flex items-center justify-between cursor-pointer border border-cyprus/5 shadow-sm animate-in fade-in slide-in-from-bottom duration-500"
                ...
                >
                  ...
                  <ChevronRight className="w-5 h-5 opacity-40 group-hover:opacity-100 transition-transform group-hover:translate-x-1" />
                </div>
              ))}
            </div>
          ) : (
            <div className="animate-in fade-in slide-in-from-bottom duration-700">
              <div className="space-y-8">
                <section>
                  ...
                  <div className="glass p-5 rounded-2xl border border-cyprus/5 shadow-sm">
                ...
                <section>
                  ...
                  <div className="flex flex-col gap-3">
                    {contactData[selectedDept].mentors.map((mentor, idx) => (
                      <div key={idx} className="glass p-5 rounded-2xl border border-cyprus/5 shadow-sm">
                        <div className="grid grid-cols-3 items-center w-full text-cyprus">
